...
#&sf.player_name
………[playse storage="gaya.ogg" loop=false ][l]？[p]
...
#
[playse storage="key.ogg" sprite_time="0-2000" loop=false ][p]
#&sf.player_name
開いた……？[p]	
...
*select1-3
#
[playse storage="dash.ogg" loop=false][p]
[eval exp="f.amazing[8] = f.amazing[8] - 2"]	
#？？？	
...
[mask time=500]
[playbgm storage="t_atsuhime.ogg"]
[mask_off time=500]
