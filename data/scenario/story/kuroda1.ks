...
[playse storage="walk.ogg" loop=false ]
[delay speed="200"] 
・・・・・・[p] 
[resetdelay][stopse]
...
*next1	
[playse storage="open_hikido.ogg" loop=false ][p][stopse]
...
[playse storage="knock.ogg" loop=false ][p][stopse]
...
[mask time=500]
[playse storage="tatami.ogg" loop=false]
...
[playse storage="garasu.ogg" sprite_time="0-2000" loop=false][wait time="200"]
#&sf.player_name	
...
#
[playse storage="dive.ogg" sprite_time="0-2000" loop=false ][p]	
