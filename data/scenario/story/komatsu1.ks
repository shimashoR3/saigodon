...
（不審者だったら大変だし、開けよう！）	[p]
[mask time=250]
[playse storage="husuma.mp3" sprite_time="0-2000" loop=false]
...
[playse storage="lake.mp3" sprite_time="0-2000" loop=false ][p]	
...
[playse storage="tatami.mp3" sprite_time="0-2000" loop=false ]	
[wait time=2000]	
