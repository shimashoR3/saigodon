...
#
[playse storage="gaya.mp3" loop=false ][p][stopse]

#西郷隆盛
…[l]ん？なんかあっちが騒がしいな。行ってみるか！[p]

#
[playse storage="dash.mp3" sprite_time="0-2000" loop=false ]
[delay speed="200"] 
・・・・・・[p] 
[resetdelay][stopse]
...
[delay speed="200"][playse storage="dash.mp3" sprite_time="0-2000" loop=false ] 
・・・・・・[p] 
[resetdelay][stopse]	
…ちっ、全然捕まらねぇ。[l][r]	
...
[font reset]
[playse storage="dive.mp3" loop=false][wait time=200]
