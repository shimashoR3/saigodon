...
#
[playse storage="walk.mp3" sprite_time="0-2000" loop=false]
[delay speed="200"] 
・・・・・・[p] 
[resetdelay]
...
[playse storage="walk.mp3" loop=false][p]
...
[playse storage=rain.mp3 loop=false time=3000]	
...
[eval exp="f.amazing[4] = f.amazing[4] + 5"]
#	
[playse storage="lake.mp3" loop=false][p]		
