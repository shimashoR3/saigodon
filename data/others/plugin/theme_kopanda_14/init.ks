...
;	クイックセーブボタン
	[button name="role_button" role="quicksave" graphic="../others/plugin/theme_kopanda_14/image/button/qsave.png" enterimg="../others/plugin/theme_kopanda_14/image/button/qsave2.png" x="840" y="510" width="60"]

;	クイックロードボタン
	[button name="role_button" role="quickload" graphic="../others/plugin/theme_kopanda_14/image/button/qload.png" enterimg="../others/plugin/theme_kopanda_14/image/button/qload2.png" x="904" y="510" width="60"]

;	オートボタン
	[button name="role_button" role="auto" graphic="../others/plugin/theme_kopanda_14/image/button/auto.png" enterimg="../others/plugin/theme_kopanda_14/image/button/auto2.png" x="968" y="510" width="60"]

;	スキップボタン
	[button name="role_button" role="skip" graphic="../others/plugin/theme_kopanda_14/image/button/skip.png" enterimg="../others/plugin/theme_kopanda_14/image/button/skip2.png" x="1032" y="510" width="60"]

;	バックログボタン
	[button name="role_button" role="backlog" graphic="../others/plugin/theme_kopanda_14/image/button/log.png" enterimg="../others/plugin/theme_kopanda_14/image/button/log2.png" x="1096" y="510" width="60"]

;	メニュー呼び出しボタン
	[button name="role_button" role="menu" graphic="../others/plugin/theme_kopanda_14/image/button/menu.png" enterimg="../others/plugin/theme_kopanda_14/image/button/menu2.png" x="1190" y="10" width="80"]
...
[macro  name="add_map_button"]

[button graphic="../others/plugin/theme_kopanda_14/image/button/menu.png" enterimg="../others/plugin/theme_kopanda_14/image/button/menu.png"  x="1190" y="10" width="80" storage="../scenario/menu/menu2.ks"]
